myApp.controller('GameController', ['$scope', '$rootScope', 'Authentication', 'sharedExercises', '$ionicPopup', '$timeout', '$firebaseAuth', 'FIREBASE_URL',
  function($scope, $rootScope, Authentication, sharedExercises, $ionicPopup, $timeout, $firebaseAuth, FIREBASE_URL) {
    ...
    // have a predetermined rhythm as represented through numeric values.
    // the numeric value both outlines how the user should tap his or her rhythm
    // as well as how the program displays notes in the rhythmDisplay

    // after you track the user's rhythm
    // compare this rhythm to the gameRhythm and give a response of how accurately the user tapped the screen.
